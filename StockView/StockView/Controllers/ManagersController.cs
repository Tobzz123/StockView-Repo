...
*/
        ...
        public async Task<IActionResult> Create([Bind("ManagerId,Email,FirstName,LastName,ManagerUserName,ManagerUserRole")] Manager manager)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ManagerId,Email,FirstName,LastName,ManagerUserName,ManagerUserRole")] Manager manager)
        {
